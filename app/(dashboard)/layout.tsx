    ...
    <aside className="fixed inset-y-0 left-0 z-10 hidden w-20 flex-col border-r bg-background sm:flex">
      <nav className="flex flex-col items-center gap-4 px-2 sm:py-5">
        ...
        <NavItem href="#" label="Dashboard">
          <Home className="h-5 w-5 hover:text-red-500 transition-all duration-300" />
        </NavItem>

        <NavItem href="#" label="Orders">
          <ShoppingCart className="h-5 w-5 hover:text-red-500 transition-all duration-300" />
        </NavItem>

        <NavItem href="/" label="Products">
          <Package className="h-5 w-5 hover:text-red-500 transition-all duration-300" />
        </NavItem>

        <NavItem href="/customers" label="Customers">
          <Users2 className="h-5 w-5 hover:text-red-500 transition-all duration-300" />
        </NavItem>

        <NavItem href="#" label="Analytics">
          <LineChart className="h-5 w-5 hover:text-red-500 transition-all duration-300" />
        </NavItem>
      </nav>
